            ...
            foreach ($posts as $post) {
               $nameArray = json_decode($post['image'], true);
                ...
                foreach ($nameArray as $imgName) {
                    $data .= '
                  <a href="#" id="' . $post['ID'] . '" data-bs-toggle="modal"
                   data-bs-target="#detail_post_modal" class="post_detail_btn">
                   <img src="uploads/avatar/'
                . $imgName['filename'] . '" class="img-fluid card-img-top"></a>';
                }
                $data .= '<div class="card-body">
                  ...
                  <div class="card-footer d-flex justify-content-between align-items-center">
                    ...
                    <div>
                      <a href="#" id="' . $post['ID'] . '" data-bs-toggle="modal"
                       data-bs-target="#edit_post_modal" class="btn btn-success btn-sm post_edit_btn">Edit</a>
